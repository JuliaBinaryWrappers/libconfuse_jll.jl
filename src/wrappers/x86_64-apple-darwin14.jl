# Autogenerated wrapper script for libconfuse_jll for x86_64-apple-darwin14
export libconfuse
...
const libconfuse_splitpath = ["lib", "libconfuse.2.dylib"]
...
const libconfuse = "@rpath/libconfuse.2.dylib"

...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libconfuse_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9f03c2a6-2865-5578-ae11-af8a29163b66"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libconfuse", artifacts_toml) for e in artifacts["libconfuse"]]
...
if best_platform === nothing
    @debug("Unable to load libconfuse; unsupported platform $(triplet(platform_key_abi()))")
else
